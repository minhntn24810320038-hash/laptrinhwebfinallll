document.addEventListener("DOMContentLoaded", function () {
  // ==========================================
  // 1. ĐỒNG BỘ TRẠNG THÁI ĐĂNG NHẬP (TRANG CHỦ)
  // ==========================================
  ...
  // ==========================================
  // 2. KHỞI TẠO BIẾN & DỮ LIỆU CƠ SỞ GIỎ HÀNG CHUNG
  // ==========================================
  let cart = JSON.parse(localStorage.getItem("gentleman_cart")) || [];
  const sizesAvailable = ["M", "L", "XL", "XXL"]; // Danh sách size đồng bộ chuẩn
  ...
  // ==========================================
  // 3. LOGIC ĐÓNG / MỞ SIDEBAR GIỎ HÀNG (.open)
  // ==========================================
  ...
  productCards.forEach((card) => {
    card.addEventListener("click", function () {
      currentProduct = {
        id: this.getAttribute("data-id") || "A0",
        name:
        ...
        code: this.getAttribute("data-code") || "SM-00",
      };
      ...
      if (sizeContainer) {
        sizeContainer.innerHTML = sizesAvailable
          .map(
            (size) =>
  ...
  // KÍCH HOẠT HỆ THỐNG LÕI TRÊN TRANG ÁO
